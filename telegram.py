        ...
        for group in tqdm(old_groups):
            ...
            try:
                ...
                for m in messages:
                    ...
                    if m.fwd_from:
                        if hasattr(m.fwd_from ,'channel_id'):
                            new_edges.append([group, m.fwd_from.channel_id])
                            if m.fwd_from.channel_id not in new_groups:
                                if m.fwd_from.channel_id not in visited_channels:
